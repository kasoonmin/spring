...
public class MailController {
	...
	public void sendSimpleMail(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		sb.append("신간 도서를소개합니다.<br><br>");
		sb.append("<a href='http://www.kyobobook.co.kr/product/datailViewKor.laf?ejkGb=KOR&mallGb=KOR&barcode=9788956746425&orderClick=LAG&Kc=#N'>");
		...
		mailService.sendMail("korea9601@naver.com","2번 테스트 메일",str);	
		out.print("메일을 보냈습니다.!!");
	}
}
